...
namespace ZoomAndPan.Core
{
    ...
    public partial class ZoomAndPanControl
    {
        ...
        {
            if (disableScrollOffsetSync) return;
        ...
        {
            if (IsMouseWheelScrollingEnabled) LineDown();
        }
        ...
        {
            if (IsMouseWheelScrollingEnabled) LineLeft();
        }
        ...
        {
            if (IsMouseWheelScrollingEnabled) LineRight();
        }
        ...
        {
            if (IsMouseWheelScrollingEnabled) LineUp();
        }
